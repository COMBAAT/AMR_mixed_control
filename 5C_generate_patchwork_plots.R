...
my_ggsave(plot = figB, filename = "output/ms_figs/5pC_use_as_fig7a.pdf", width = 14, height = 14) # best size
...
figB <- figB + plot_annotation(title = "Responsive longlasting treatment",
                               theme = theme(plot.title = element_text(size = 24, hjust = 0.4)))
my_ggsave(plot = figB, filename = "output/ms_figs/5pC_use_as_fig7b.pdf", width = 14, height = 14) # best size

############################################
this_font_size = 16
figX.1 <- plots3F$plot_type15_invasion_1_ttype3_spec_FALSE_FALSE_vector_value_20_fit_adj_0.6_single_panel
figX.1 <- add_fancy_title(figX.1, "Collective insecticide", "", "Relative fitness 0.6" )
...
figB <- figB + plot_annotation(title = "Ongoing longlasting treatment",
                               theme = theme(plot.title = element_text(size = 24, hjust = 0.4)))
my_ggsave(plot = figB, filename = "output/ms_figs/5pC_use_as_fig7c.pdf", width = 14, height = 14) # best size

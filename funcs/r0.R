...
create_named_vector_of_transition_probabilities <- function(params, is_strain_sensitive) {
  transition_probabilities <- with(as.list(params, is_strain_sensitive), {
    ...
    prob_CI_from_CE <- gamma_c / (gamma_c + death_c + proph_ongoing2)
    prob_PI_from_PE <- gamma_c / (gamma_c + death_c + proph_ongoing2 + waning_from_PE)
    ...
    prob_waning_from_partial_protection_from_PE <- waning_from_PE / (gamma_c + death_c + waning_from_PE + proph_ongoing2)
    ...
    prob_proph_from_CE <- proph_ongoing2 / (gamma_c + death_c + proph_ongoing2)
    prob_proph_from_PE <- proph_ongoing2 / (gamma_c + death_c + proph_ongoing2 + waning_from_PE)

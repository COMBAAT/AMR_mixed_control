...
test1 <- test %>% signif(4)
p.ins <- unique(test1$prop_cattle_with_insecticide)
this_prop <- 0.05
ins2.dat <- test1 %>% filter(prop_cattle_with_insecticide == this_prop) 
this_prop <- 0.0
ins1.dat <- test1 %>% filter(prop_cattle_with_insecticide == this_prop) 
...
p.ins <- unique(test1$prop_cattle_with_insecticide)
this_prop <- 0.0
ins1.dat <- test1 %>% filter(prop_cattle_with_insecticide == this_prop & treat_prop == 0.8) 
...
K.10000 <- test1 %>% filter(K == 10000 & dose ==1, prop_cattle_with_insecticide < 0.5, prop_cattle_with_insecticide != 0.025) 
p.ins <- unique(K.10000$prop_cattle_with_insecticide)
...
col.var = "prop_cattle_with_insecticide"
shape.var = "W_st"

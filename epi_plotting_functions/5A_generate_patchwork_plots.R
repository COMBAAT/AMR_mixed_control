...
my_ggsave(plot = figA, filename = "output/ms_figs/5A_main_fig4_ttype1.pdf", width = 10, height = 9) # best size
...
figA <- ( (figX.1 + figX.4) / (figX.2 + figX.5) / (figX.3 + figX.6)) +
  plot_layout(guides = 'collect') & 
  theme(legend.position = "bottom") 
my_ggsave(plot = figA, filename = "output/ms_figs/5A_main_fig4_ttype2.pdf", width = 10, height = 9) # best size
...
figA <- ( (figX.1 + figX.4) / (figX.2 + figX.5) / (figX.3 + figX.6)) +
  plot_layout(guides = 'collect') & 
  theme(legend.position = "bottom") 
my_ggsave(plot = figA, filename = "output/ms_figs/5A_main_fig4_ttype3.pdf", width = 10, height = 9) # best size

...
figX.1 <- plots1F$plot_type15_invasion_1_treatment_code1_mainvecpop_FALSE_vector_value_25_fit_adj_0.8_single_panel_with_contours_FALSE 
...
figX.2 <- plots1T$plot_type15_invasion_1_treatment_code1_mainvecpop_TRUE_vector_value_25_fit_adj_0.8_single_panel_with_contours_FALSE 
...
figX.5 <- plots3F$plot_type15_invasion_1_treatment_code3_mainvecpop_FALSE_vector_value_25_fit_adj_0.8_single_panel_with_contours_FALSE
...
figX.6 <- plots3T$plot_type15_invasion_1_treatment_code3_mainvecpop_TRUE_vector_value_25_fit_adj_0.8_single_panel_with_contours_FALSE
...
figX.1 <- plots1F$plot_type16_landscape_treatment_code1_mainvecpop_FALSE_vector_value_25_single_panel
#figX.1 <- plots1F$plot_type16_landscape_ttype1_spec_FALSE_FALSE_vector_value_20_single_panel 
figX.1 <- add_fancy_title(figX.1, "Collective", "", "Treatment type: Responsive curative")

figX.2 <- plots1T$plot_type16_landscape_treatment_code1_mainvecpop_TRUE_vector_value_25_single_panel
#figX.2 <- plots1T$plot_type16_landscape_ttype1_spec_FALSE_TRUE_vector_value_20_single_panel
figX.2 <- add_fancy_title(figX.2,  "Local", "", "Treatment type: Responsive curative")

figX.3 <- plots2F$plot_type16_landscape_treatment_code2_mainvecpop_FALSE_vector_value_25_single_panel
#figX.3 <- plots2F$plot_type16_landscape_ttype2_spec_FALSE_FALSE_vector_value_20_single_panel
figX.3 <- add_fancy_title(figX.3,  "", "", "Treatment type: Responsive longlasting")

figX.4 <- plots2T$plot_type16_landscape_treatment_code2_mainvecpop_TRUE_vector_value_25_single_panel
#figX.4 <- plots2T$plot_type16_landscape_ttype2_spec_FALSE_TRUE_vector_value_20_single_panel
figX.4 <- add_fancy_title(figX.4,  "", "", "Treatment type: Responsive longlasting")

figX.5 <- plots3F$plot_type16_landscape_treatment_code3_mainvecpop_FALSE_vector_value_25_single_panel
#figX.5 <- plots3F$plot_type16_landscape_ttype3_spec_FALSE_FALSE_vector_value_20_single_panel
figX.5 <- add_fancy_title(figX.5,  "", "", "Treatment type: Ongoing longlasting")

figX.6 <- plots3T$plot_type16_landscape_treatment_code3_mainvecpop_TRUE_vector_value_25_single_panel

...
# ##############################################################################
figX.1 <- plots1F$plot_type5_prevalence_treatment_code1_mainvecpop_FALSE_vector_value_25 +
#figX.1 <- plots1F$plot_type5_prevalence_ttype1_spec_FALSE_FALSE_vector_value_20 + 
  ...
  guides(shape = "none") +
  ylim(0, 1)
figX.2 <- plots1F$plot_type5_RiskA_treatment_code1_mainvecpop_FALSE_vector_value_25 +
#figX.2 <- plots1F$plot_type5_RiskA_ttype1_spec_FALSE_FALSE_vector_value_20 + 
  guides(shape = "none") +
  ylim(0, 10)
figX.3 <- plots1F$plot_type5_Rres_final_treatment_code1_mainvecpop_FALSE_vector_value_25_fit_adj_0.8 +
#figX.3 <- plots1F$plot_type5_Rres_final_ttype1_spec_FALSE_FALSE_vector_value_20_fit_adj_0.8 + 
  geom_hline(yintercept = 1, linetype = "dashed") +
  guides(shape = "none") +
  ylim(0, 10)

figX.4 <- plots1T$plot_type5_prevalence_treatment_code1_mainvecpop_TRUE_vector_value_25 + 
#figX.4 <- plots1T$plot_type5_prevalence_ttype1_spec_FALSE_TRUE_vector_value_20 + 
  ggtitle("Local insecticide \n Responsive curative drug treatment") + 
  guides(shape = "none") +
  ylim(0, 1)
figX.5 <- plots1T$plot_type5_RiskA_treatment_code1_mainvecpop_TRUE_vector_value_25 + 
#figX.5 <- plots1T$plot_type5_RiskA_ttype1_spec_FALSE_TRUE_vector_value_20 + 
  guides(shape = "none") +
  ylim(0, 10)
figX.6 <- plots1T$plot_type5_Rres_final_treatment_code1_mainvecpop_TRUE_vector_value_25_fit_adj_0.8 +
...
# ##############################################################################
# ##############################################################################
figX.1 <- plots2F$plot_type5_prevalence_treatment_code2_mainvecpop_FALSE_vector_value_25 + 
#figX.1 <- plots2F$plot_type5_prevalence_ttype2_spec_FALSE_FALSE_vector_value_20 + 
  ggtitle("Collective insecticide \n Responsive longlasting drug treatment") + 
  guides(shape = "none") +
  ylim(0, 1)
figX.2 <- plots2F$plot_type5_RiskA_treatment_code2_mainvecpop_FALSE_vector_value_25 + 
#figX.2 <- plots2F$plot_type5_RiskA_ttype2_spec_FALSE_FALSE_vector_value_20 + 
  guides(shape = "none") +
  ylim(0, 10)
figX.3 <- plots2F$plot_type5_Rres_final_treatment_code2_mainvecpop_FALSE_vector_value_25_fit_adj_0.8 + 
#figX.3 <- plots2F$plot_type5_Rres_final_ttype2_spec_FALSE_FALSE_vector_value_20_fit_adj_0.8 + 
  geom_hline(yintercept = 1, linetype = "dashed") +
  guides(shape = "none") +
  ylim(0, 10)

figX.4 <- plots2T$plot_type5_prevalence_treatment_code2_mainvecpop_TRUE_vector_value_25 + 
#figX.4 <- plots2T$plot_type5_prevalence_ttype2_spec_FALSE_TRUE_vector_value_20 + 
  ggtitle("Local insecticide \n Responsive longlasting drug treatment") + 
  guides(shape = "none") +
  ylim(0, 1)
figX.5 <- plots2T$plot_type5_RiskA_treatment_code2_mainvecpop_TRUE_vector_value_25 + 
#figX.5 <- plots2T$plot_type5_RiskA_ttype2_spec_FALSE_TRUE_vector_value_20 + 
  guides(shape = "none") +
  ylim(0, 10)
figX.6 <- plots2T$plot_type5_Rres_final_treatment_code2_mainvecpop_TRUE_vector_value_25_fit_adj_0.8 + 
...
# ##############################################################################
# ##############################################################################
figX.1 <- plots3F$plot_type5_prevalence_treatment_code3_mainvecpop_FALSE_vector_value_25 + 
#figX.1 <- plots3F$plot_type5_prevalence_ttype3_spec_FALSE_FALSE_vector_value_20 + 
  ggtitle("Collective insecticide \n Ongoing longlasting drug treatment") + 
  guides(shape = "none") +
  ylim(0, 1)
figX.2 <- plots3F$plot_type5_RiskA_treatment_code3_mainvecpop_FALSE_vector_value_25 + 
#figX.2 <- plots3F$plot_type5_RiskA_ttype3_spec_FALSE_FALSE_vector_value_20 + 
  guides(shape = "none") +
  ylim(0, 10)
figX.3 <- plots3F$plot_type5_Rres_final_treatment_code3_mainvecpop_FALSE_vector_value_25_fit_adj_0.8 + 
#figX.3 <- plots3F$plot_type5_Rres_final_ttype3_spec_FALSE_FALSE_vector_value_20_fit_adj_0.8 + 
  geom_hline(yintercept = 1, linetype = "dashed") +
  guides(shape = "none") +
  ylim(0, 10)

figX.4 <- plots3T$plot_type5_prevalence_treatment_code3_mainvecpop_TRUE_vector_value_25 + 
#figX.4 <- plots3T$plot_type5_prevalence_ttype3_spec_FALSE_TRUE_vector_value_20 + 
  ggtitle("Local insecticide \n Ongoing longlasting drug treatment") + 
  guides(shape = "none") +
  ylim(0, 1)
figX.5 <- plots3T$plot_type5_RiskA_treatment_code3_mainvecpop_TRUE_vector_value_25 + 
#figX.5 <- plots3T$plot_type5_RiskA_ttype3_spec_FALSE_TRUE_vector_value_20 + 
  guides(shape = "none") +
  ylim(0, 10)
figX.6 <- plots3T$plot_type5_Rres_final_treatment_code3_mainvecpop_TRUE_vector_value_25_fit_adj_0.8 + 
...
figX.1 <- plots1F$plot_type6_Rres_final_treatment_code1_mainvecpop_FALSE_vector_value_25_fit_adj_0.8 + 
...
figX.2 <- plots2F$plot_type6_Rres_final_treatment_code2_mainvecpop_FALSE_vector_value_25_fit_adj_0.8 + 
...
coord_cartesian(ylim = c(0, 10)) 
figX.3 <- plots3F$plot_type6_Rres_final_treatment_code3_mainvecpop_FALSE_vector_value_25_fit_adj_0.8 + 
...
# ##############################################################################
figX.1 <- plots1T$plot_type6_Rres_final_treatment_code1_mainvecpop_TRUE_vector_value_25_fit_adj_0.8 + 
#figX.1 <- plots1T$plot_type6_Rres_final_ttype1_spec_FALSE_TRUE_vector_value_20_fit_adj_0.8 + 
  ggtitle(my_title("curative", split_across_lines = "other")) + guides(linetype = "none") + 
  coord_cartesian(ylim = c(0, 10))
figX.2 <- plots2T$plot_type6_Rres_final_treatment_code2_mainvecpop_TRUE_vector_value_25_fit_adj_0.8 + 
#figX.2 <- plots2T$plot_type6_Rres_final_ttype2_spec_FALSE_TRUE_vector_value_20_fit_adj_0.8 + 
  ggtitle(my_title("longlasting", split_across_lines = "other")) + guides(linetype = "none") + 
  coord_cartesian(ylim = c(0, 10)) 
figX.3 <- plots3T$plot_type6_Rres_final_treatment_code3_mainvecpop_TRUE_vector_value_25_fit_adj_0.8 + 

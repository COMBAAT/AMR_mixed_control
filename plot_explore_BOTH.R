...
pdf(file="output/plots_both/1_r0sen.pdf")
plot_R0_Sen_dd(ins1.dat, c(0, 0.6,0.95), fitadj = fitadj)
dev.off()

pdf(file="output/plots_both/2_resvsen.pdf")
...
label <- "FALSE"
pdf(file="output/plots_both/3_r0sen_tp.pdf")
...
ymax <- as.numeric(1)
label <- "FALSE"
pdf(file="output/plots_both/4_prevsen_tp.pdf")
...
ymax <- as.numeric(axislims["plotlims.max"])
label <- "FALSE"
pdf(file="output/plots_both/5_incsen_tp.pdf")
plot_PT.Y(ins1.dat, Wn = c(0,100,250), fitadj = fitadj, my_theme, my_par, this_var, y_label, prev_threshold, ymin, ymax, label = label)
dev.off()
...
ymax <- as.numeric(axislims["plotlims.max"])
label <- "FALSE"
pdf(file="output/plots_both/6_notrtsen_tp.pdf")
plot_PT.Y(ins1.dat, Wn = c(0,100,250), fitadj = fitadj, my_theme, my_par, this_var, y_label, prev_threshold, ymin, ymax, label = label)
dev.off()
...
ymax <- as.numeric(axislims["plotlims.max"])
label <- "FALSE"
pdf(file="output/plots_both/7_probontran_tp.pdf")
plot_PT.Y(ins1.dat, Wn = c(0,100,250), fitadj = fitadj, my_theme, my_par, this_var, y_label, prev_threshold, ymin, ymax, label = label)
dev.off()
...
pdf(file="output/plots_both/8a_risk_Atp.pdf")
plot_PT.Y(ins1.dat, Wn = c(0,100,250), fitadj = fitadj, my_theme, my_par, this_var, y_label, prev_threshold, ymin, ymax, label = label)
dev.off()
...
label <- "FALSE"
#plot_PT.Y(ins1.dat, Wn = c(0,100,250), fitadj = fitadj, my_theme, my_par, this_var, y_label, prev_threshold, ymin, ymax, label = label, this_prop = this_prop)
pdf(file="output/plots_both/8_riskE_tp.pdf")
plot_PT.Y(ins1.dat, Wn = c(0,100,250), fitadj = fitadj, my_theme, my_par, this_var, y_label, prev_threshold, ymin, ymax, label = label)
dev.off()
...
shape.var = "W_st"
pdf(file="output/plots_both/inc1_10k_RiskA.pdf")
...
col.var = "prop.insecticide"
shape.var = "W_st"
pdf(file="output/plots_both/inc1_10k_RiskA_pt0.1.pdf")
...
col.var = "prop.insecticide"
shape.var = "W_st"
pdf(file="output/plots_both/inc1_10k_RiskA_pt0.05.pdf")
...
col.var = "prop.insecticide"
shape.var = "W_st"
pdf(file="output/plots_both/inc1_10k_RiskA_pt1.pdf")
...
col.var = "prop.insecticide"
shape.var = "W_st"
pdf(file="output/plots_both/inc1_10k_RiskA_pt0.1it100.pdf")
...
col.var = "prop.insecticide"
shape.var = "W_st"
pdf(file="output/plots_both/inc1_10k_RiskA_pt0.05it10.pdf")
